...
function getCatalogError(error: unknown) {
  return error instanceof Error ? error.message : 'Nao foi possivel carregar mais filmes.';
}
  ...
  async function handleLoadMore() {
    ...
    try {
      ...
      const payload = (await response.json()) as
        | { success: true; data: { items: CatalogMovie[]; page: number } }
    ...
    <div className="home-workspace">
      <main className="catalog-page">
        ...
        <section className="catalog-hero" aria-labelledby="catalog-title">
          ...
          <p>{totalResults.toLocaleString('pt-BR')} filmes encontrados pela curadoria de notas.</p>
        </section>
